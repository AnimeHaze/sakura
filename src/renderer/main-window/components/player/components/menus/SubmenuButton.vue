...
<template>
  <media-menu-button
    class="ring-media-focus parent left-0 z-10 flex cursor-pointer select-none items-center justify-start rounded-sm bg-black/60 p-2.5 outline-none ring-inset data-[open]:sticky data-[open]:-top-2.5 data-[hocus]:bg-white/10 data-[focus]:ring-[3px] aria-hidden:hidden"
  >
    <media-icon
